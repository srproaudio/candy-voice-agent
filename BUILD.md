...
This guide covers how to set up the development environment and build Candy from source across different platforms.
...
```bash
git clone git@github.com:dlm-media/candy.git
cd Candy
```
